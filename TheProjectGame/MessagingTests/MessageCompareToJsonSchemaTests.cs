            ...
            foreach (var message in messages)
            {
                ...
                switch (message.MessageId)
                {
                    ...
                    case MessageId.ExchangeInformationResponse:
                        ...
                        schema = File.ReadAllText(@"..\..\..\..\Messaging\Schema\Agent\informationExchangeRespond.json");
                        break;
                    ...
                    case MessageId.PutDownPieceResponse:
                        ...
                        schema = File.ReadAllText(@"..\..\..\..\Messaging\Schema\GameMaster\putPieceResponse.json");
                        break;

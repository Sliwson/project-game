...
namespace AgentTests
{
    public class CommonTest
    {
        ...
        {
            int shortTime = 4;
            Agent.Agent agentRed = new Agent.Agent(TeamId.Red, false);
            ...
            agentRed.initializeComponent.Initialize(startGamePayload);
            Assert.AreNotEqual(Common.GetGoalDirection(agentRed, shortTime), Direction.South);
            Agent.Agent agentBlue = new Agent.Agent(TeamId.Blue, false);
            ...
            agentBlue.initializeComponent.Initialize(startGamePayload);
